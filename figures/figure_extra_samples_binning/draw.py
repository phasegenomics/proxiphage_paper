...
def main():
    ...
    samples = ["human_gut", "rumen", "wastewater"]
    sample_names = ["Human fecal", "Cow rumen", "Wastewater"]
    for i, sample in enumerate(samples):
        ...
        plot_barplot([contigs_comps, vmags_comps], names, ax1)
    ...
    axes[2].legend(bbox_to_anchor=(0.9, -0.32), ncol=len(PERCENTILE_CATEGORIES), facecolor=None,
              prop={'size': MAIN_FONT}, frameon=True, fontsize=MAIN_FONT,
              title="Categories of viral genome completion", columnspacing=0.3)
    axes[2].set_xlabel("Number of viral genomes", fontsize=AXIS_FONT)
